            ...
            <div class="row">
                <div class="col span-1-of-5 cities-box">
                   <img src="images/919.jpg"><br><br>
                    <h3><a href="alasjt.php" class="cant" style="text-decoration: none; border: 2px solid #18314f; border-radius: 4px; padding: 2px 4px;">Canteen 1</a><br><br>Inside Twin Tower</h3>
                </div>
                <div class="col span-1-of-5 cities-box">
                   <img src="images/943.jpg"><br><br>
                    <h3><a href="aladc.php" class="cant" style="text-decoration: none; border: 2px solid #18314f; border-radius: 4px; padding: 2px 4px;">DC</a><br><br>Near TwinTower</h3>
                </div>
                <div class="col span-1-of-5 cities-box">
                   <img src="images/2015.jpg"><br><br>
                    <h3><a href="alanac.php" class="cant" style="text-decoration: none; border: 2px solid #18314f; border-radius: 4px; padding: 2px 4px;">FC (Non AC)</a><br><br>Near Twin Tower</h3>
                </div>
                <div class="col span-1-of-5 cities-box">
                   <img src="images/2038.jpg"><br><br>
                    <h3><a href="alaac.php" class="cant" style="text-decoration: none; border: 2px solid #18314f; border-radius: 4px; padding: 2px 4px;">FC (AC)</a><br><br>Near TwinTower</h3>
                </div>
                <div class="col span-1-of-5 cities-box">
                    <img src="images/2299.jpg"><br><br>
                     <h3><a href="aladar.php" class="cant" style="text-decoration: none; border: 2px solid #18314f; border-radius: 4px; padding: 2px 4px;">Apex Canteen</a><br><br>Golf course 2 Area</h3>
                 </div>
            </div>
            <div class="row">
            <br><br><br>
